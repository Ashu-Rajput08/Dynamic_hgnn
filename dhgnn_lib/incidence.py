...
matrix ``H_aug(t) = [ H_spatial(t) | H_lineage | H_functional | H_anastomosis(t) ]``.
"""
...
def assemble(
    ...
    anastomosis: HyperedgeSet,
) -> HyperedgeBatch:
    """Concatenate the four hyperedge blocks into one HyperedgeBatch."""

    blocks = [
        (spatial, EDGE_TYPE_SPATIAL),
        (lineage, EDGE_TYPE_LINEAGE),
        (functional, EDGE_TYPE_FUNCTIONAL),
        (anastomosis, EDGE_TYPE_ANASTOMOSIS),
    ]
